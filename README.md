...
2. Godmode
  ...
  - Nullify damage to user's character and enable one-hit-kills of enemies.
...
Compile the library in release mode to `target/release/`:
...
Compile the library with debug symbols to `target/debug/`:
